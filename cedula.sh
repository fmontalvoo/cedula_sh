...
# Funcion que verifica el número de cédula.
verificar_numero(){

	cedula=$1 # Recibe el numero de cédula como parametro de la función.
...
# Recibe el número de cédula como parametro del script.
verificar_numero $1
